    ...
    defineTool({
      ...
      parameters: {
        ...
        recipeId: {
          type: "string",
          description:
            'Built-in recipe: "balance_threshold_alert", "price_band_alert", "price_cross_alert", or "price_cross_swap".',
          enum: [
