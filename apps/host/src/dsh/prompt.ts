...
export function buildAgentIdentityBlock(
  ...
  lines.push(
    ...
    '- recipeId must be "balance_threshold_alert", "price_band_alert", "price_cross_alert", "price_cross_swap", "take_profit_stop", "inventory_rebalance", "stable_depeg_alert", or "pool_liquidity_shock". Runtime is deterministic — the host runs the recipe, not an LLM tick.',
