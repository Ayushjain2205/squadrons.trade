...
export function buildAgentIdentityBlock(
  ...
  lines.push(
    ...
    '- recipeId must be "balance_threshold_alert", "price_band_alert", "price_cross_alert", or "price_cross_swap". Runtime is deterministic — the host runs the recipe, not an LLM tick.',
    ...
    '- action.type is "alert" or "propose_trade" (observe agents should prefer alert; use propose_trade with price_cross_swap).',
